...
class HeaderFullScreen extends HeaderType {
    ...
    public function __construct() {
        ...
        if(!is_admin()) {
            ...
            $menuAreaHeight       = ambient_elated_filter_px(ambient_elated_options()->getOptionValue('menu_area_height_header_full_screen'));
    ...
    public function loadTemplate($parameters = array()) {
        ...
        $parameters = apply_filters('ambient_elated_header_fullscreen_parameters', $parameters);
    ...
    public function calculateHeightOfTransparency() {
        ...
        } else if (ambient_elated_options()->getOptionValue('menu_area_background_transparency_header_full_screen') !== '1' && ambient_elated_options()->getOptionValue('menu_area_background_transparency_header_full_screen') !== '') {
            $menuAreaTransparent = true;
