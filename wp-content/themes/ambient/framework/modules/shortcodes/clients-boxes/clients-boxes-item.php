<?php
namespace AmbientElatedNamespace\Modules\Shortcodes\ClientsBoxesItem;
...
class ClientsBoxesItem implements ShortcodeInterface{
	...
	public function __construct() {
		$this->base = 'eltdf_clients_boxes_item';
	...
	public function render($atts, $content = null) {
		...
		$html = ambient_elated_get_shortcode_module_template_part('templates/clients-boxes-item', 'clients-boxes', '', $params);
