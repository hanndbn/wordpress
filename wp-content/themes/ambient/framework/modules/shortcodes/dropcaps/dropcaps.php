<?php
namespace AmbientElatedNamespace\Modules\Shortcodes\Dropcaps;
...
class Dropcaps implements ShortcodeInterface {
	...
	public function render($atts, $content = null) {
		...
		$html = ambient_elated_get_shortcode_module_template_part('templates/dropcaps-template', 'dropcaps', '', $params);
	...
	private function getDropcapsClass($params) {
		return ($params['type'] !== '') ? 'eltdf-'.$params['type'] : '';
	}
}