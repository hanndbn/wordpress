<?php
namespace AmbientElatedNamespace\Modules\Shortcodes\ImageWithText;
...
class ImageWithText implements ShortcodeInterface{
	...
	public function vcMap() {
		vc_map(array(
			'name'                      => esc_html__('Elated Image With Text', 'ambient'),
			'base'                      => $this->getBase(),
			...
			'params'                    => array(
				...
				array(
					...
					'heading'	  => esc_html__('Enable Lightbox Functionality', 'ambient'),
	...
	public function render($atts, $content = null) {
		...
		$html = ambient_elated_get_shortcode_module_template_part('templates/image-with-text', 'image-with-text', '', $params);
