<div class="eltdf-blog-holder eltdf-blog-type-masonry eltdf-masonry-full-width eltdf-masonry-pagination-<?php echo ambient_elated_options()->getOptionValue('masonry_pagination'); ?>">
