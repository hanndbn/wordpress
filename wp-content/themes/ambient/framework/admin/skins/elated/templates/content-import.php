    ...
    <div class="tab-content">
        <div class="tab-pane fade in active" id="import">
            <div class="eltdf-tab-content">
                <h2 class="eltdf-page-title"><?php esc_html_e('Import' , 'ambient') ?></h2>
                    ...
                    <div class="eltdf-page-form">
                        <div class="eltdf-page-form-section-holder">
                            <h3 class="eltdf-page-section-title">
                                <?php esc_html_e('Import Demo Content' , 'ambient') ?>
                            </h3>
                            <div class="eltdf-page-form-section">
                                <div class="eltdf-field-desc">
                                    <h4>
                                        <?php esc_html_e('Import' , 'ambient') ?>
                                    </h4>

                                    <p>
                                        <?php esc_html_e('Choose demo content you want to import' , 'ambient') ?>
                                    </p>
                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <select name="import_example" id="import_example" class="form-control eltdf-form-element dependence">
                                                    <option value="ambient"><?php esc_html_e('Ambient' , 'ambient') ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="eltdf-page-form-section">
                                ...
                                <div class="eltdf-field-desc">
                                    <h4>
                                        <?php esc_html_e('Import Type' , 'ambient') ?>
                                    </h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <select name="import_option" id="import_option" class="form-control eltdf-form-element">
                                                    <option value=""><?php esc_html_e('Please Select' , 'ambient') ?></option>
                                                    <option value="complete_content"><?php esc_html_e('All' , 'ambient') ?></option>
                                                    <option value="content"><?php esc_html_e('Content' , 'ambient') ?></option>
                                                    <option value="widgets"><?php esc_html_e('Widgets' , 'ambient') ?></option>
                                                    <option value="options"><?php esc_html_e('Options' , 'ambient') ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="eltdf-page-form-section">
                                ...
                                <div class="eltdf-field-desc">
                                    <h4><?php esc_html_e('Import attachments' , 'ambient') ?></h4>

                                    <p><?php esc_html_e('Do you want to import media files?' , 'ambient') ?></p>
                                </div>
                                <!-- close div.eltdf-field-desc -->
                                <div class="eltdf-section-content">
                                    <div class="container-fluid">
                                            ...
                                            <div class="col-lg-12">
                                                <p class="field switch">
                                                    <label class="cb-enable dependence">
                                                        <span>
                                                           <?php esc_html_e('Yes' , 'ambient') ?>
                                                        </span>
                                                    </label>
                                                    <label class="cb-disable selected dependence">
                                                        <span>
                                                            <?php esc_html_e('No' , 'ambient') ?>
                                                        </span>
                                                    </label>
                            ...
                            <div class="eltdf-page-form-section">
                                ...
                                <div class="eltdf-section-content">
                                    <div class="container-fluid">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="import_load"><span><?php esc_html_e('The import process may take some time. Please be patient.', 'ambient') ?> </span><br />
                            ...
                            <div class="eltdf-page-form-section eltdf-import-button-wrapper">
                                ...
                                <div class="alert alert-warning">
                                    <strong><?php esc_html_e('Important notes:', 'ambient') ?></strong>
                                    <ul>
                                        <li><?php esc_html_e('Please note that import process will take time needed to download all attachments from demo web site.', 'ambient'); ?></li>
                                        <li> <?php esc_html_e('If you plan to use shop, please install WooCommerce before you run import.', 'ambient')?></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            $(document).on('click', '#import_demo_data', function(e) {
                ...
                if (confirm('Are you sure, you want to import Demo Data now?')) {
                    ...
                    if(import_opt == 'content'){
                        for(var i=1;i<10;i++){
                            var str;
                            if (i < 10) str = 'ambient_content_0'+i+'.xml';
                            else str = 'ambient_content_'+i+'.xml';
                            jQuery.ajax({
                                type: 'POST',
                                url: ajaxurl,
                                data: {
